...
namespace GuardDispatchSystem
{
    public partial class ReceiveReport : System.Web.UI.Page
    {
         ...
         public void BindGridview()
        {
            ...
            DataSet ds = da.GetRows("select Plant, BU,UserName,ReceiveName,ReceiveEmpID,GoodsType,GoodsName,Qty,Remark,UpdateTime　from ReceiveLog  where 1=1 "+sql+" ");
            ...
            {
                RegisterStartupScript("", "<script>alert('所查结果为空，请确认查询条件！')</script>");
                gridView.DataSource = ds;
                gridView.DataBind();
            }
        ...
        protected void imgExport_Click(object sender, ImageClickEventArgs e)
        {
            ...
            DataSet ds = da.GetRows(" select Plant, BU,UserName,ReceiveEmpID,ReceiveName, GoodsType,GoodsName,Qty,Remark,UpdateTime From ReceiveLog where 1=1  " + sql + " ");
            if (ds.Tables[0].Rows.Count > 0)
            {
                DataTable dt = new DataTable();
                dt = ds.Tables[0];
                CreateExcelByXml(dt,plant+ " 疫情物資領取詳情報表", "ExceptionSystem (" + DateTime.Now.ToShortDateString() + ").xls");
        ...
        public void CreateExcelByXml(DataTable dt, String TableTitle, string fileName)
        {
            ...
            if (dt != null)
            {
                ...
                strb.Append(" <td style=\"vnd.ms-excel.numberformat:@;text-align:center;background:#CCC;\"> <b>" + "BU" + " </b> </td>");
                strb.Append(" <td style=\"vnd.ms-excel.numberformat:@;text-align:center;background:#CCC;\"> <b>" + "系統操作員" + " </b> </td>");
                strb.Append(" <td style=\"vnd.ms-excel.numberformat:@;text-align:center;background:#CCC;\"> <b>" + "領用人工號" + " </b> </td>");
                strb.Append(" <td style=\"vnd.ms-excel.numberformat:@;text-align:center;background:#CCC;\"> <b>" + "領用人姓名" + " </b> </td>");
                ...
                strb.Append(" <td style=\"vnd.ms-excel.numberformat:@;text-align:center;background:#CCC;\"> <b>" + "領取數量" + " </b> </td>");
                strb.Append(" <td style=\"vnd.ms-excel.numberformat:@;text-align:center;background:#CCC;\"> <b>" + "備註" + " </b> </td>");
                ...
                strb.Append(" <td style=\"vnd.ms-excel.numberformat:@;text-align:center;\"> <b> </b> <b> </b><b>" + "物資領取數量總和：" + " </b>" + qty + " </td>");
                strb.Append(" </tr>");
